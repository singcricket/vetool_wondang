...
const iopTests: OphTestItem[] = [
  {
    ...
    ranges: [
      ...
      { min: 40, max: null, resultText: 'Severely elevated IOP OD — acute glaucoma', resultTextKo: '우안 심각한 안압 상승 — 급성 녹내장', isAbnormal: true, severity: 'critical', signs: ['high_iop_od', 'very_high_iop_od'] },
    ],
  },
  {
    ...
    ranges: [
      ...
      { min: 40, max: null, resultText: 'Severely elevated IOP OS', resultTextKo: '좌안 심각한 안압 상승', isAbnormal: true, severity: 'critical', signs: ['high_iop_os', 'very_high_iop_os'] },
    ],
  },
]
...
const visionAssessmentTests: OphTestItem[] = [
  {
    testID: 'obstacle_course', testName: 'Obstacle Course', testNameKo: '장애물 코스',
    domain: 'vision_assessment', eye: 'OU', species: 'both', required: false, clinicalSignificance: 'critical',
    howTo: 'Lead animal through obstacle course in photopic (bright) and scotopic (dim) light. Scotopic deficits = rod disease (early PRA, SARD).',
    testType: 'select',
    options: [
      { value: 'normal_both', label: 'Navigates normally — photopic & scotopic', labelKo: '명소/암소시 모두 정상 통과', resultText: 'Visual navigation normal', resultTextKo: '장애물 코스 통과 정상', isAbnormal: false },
      { value: 'deficient_scotopic', label: 'Deficient in scotopic only (night blindness)', labelKo: '암소시만 결함 (야맹증)', resultText: 'Scotopic visual deficiency — rod disease suspected', resultTextKo: '암소시 결함 — 간상세포 질환 의심', isAbnormal: true, severity: 'moderate' },
      { value: 'deficient_photopic', label: 'Deficient in photopic (cone disease)', labelKo: '명소시 결함 (추상세포 질환)', resultText: 'Photopic visual deficiency', resultTextKo: '명소시 결함', isAbnormal: true, severity: 'moderate' },
      { value: 'blind', label: 'Unable to navigate — functionally blind', labelKo: '통과 불가 — 기능적 실명', resultText: 'Functionally blind in obstacle course', resultTextKo: '장애물 코스 통과 불가 (기능적 실명)', isAbnormal: true, severity: 'critical' },
    ],
  },
  {
    testID: 'visual_placing_od', testName: 'Visual Placing (OD)', testNameKo: '시각 배치 반응 (우안)',
    domain: 'vision_assessment', eye: 'OD', species: 'both', required: false, clinicalSignificance: 'critical',
    howTo: 'Hold the animal and bring it towards the edge of a table. Normal = lifts paws to place on the table before touching it.',
    testType: 'select',
    options: [
      { value: 'normal', label: 'Normal response', labelKo: '정상 반응', resultText: 'Visual placing normal OD', resultTextKo: '우안 시각 배치 반응 정상', isAbnormal: false },
      { value: 'reduced', label: 'Reduced/Slow response', labelKo: '반응 저하/느림', resultText: 'Reduced visual placing OD', resultTextKo: '우안 시각 배치 반응 저하', isAbnormal: true, severity: 'mild' },
      { value: 'absent', label: 'Absent response', labelKo: '반응 소실', resultText: 'Absent visual placing OD', resultTextKo: '우안 시각 배치 반응 소실', isAbnormal: true, severity: 'moderate', signs: ['blind_od'] },
    ],
  },
  {
    testID: 'visual_placing_os', testName: 'Visual Placing (OS)', testNameKo: '시각 배치 반응 (좌안)',
    domain: 'vision_assessment', eye: 'OS', species: 'both', required: false, clinicalSignificance: 'critical',
    howTo: 'Hold the animal and bring it towards the edge of a table. Normal = lifts paws to place on the table before touching it.',
    testType: 'select',
    options: [
      { value: 'normal', label: 'Normal response', labelKo: '정상 반응', resultText: 'Visual placing normal OS', resultTextKo: '좌안 시각 배치 반응 정상', isAbnormal: false },
      { value: 'reduced', label: 'Reduced/Slow response', labelKo: '반응 저하/느림', resultText: 'Reduced visual placing OS', resultTextKo: '좌안 시각 배치 반응 저하', isAbnormal: true, severity: 'mild' },
      { value: 'absent', label: 'Absent response', labelKo: '반응 소실', resultText: 'Absent visual placing OS', resultTextKo: '좌안 시각 배치 반응 소실', isAbnormal: true, severity: 'moderate', signs: ['blind_os'] },
    ],
  },
  {
    testID: 'menace_od', testName: 'Menace Response (OD)', testNameKo: '위협 반응 검사 (우안)',
  ...
  {
    testID: 'dazzle_od', testName: 'Dazzle Reflex (OD)', testNameKo: '눈부심 반사 (우안)',
    domain: 'vision_assessment', eye: 'OD', species: 'both', required: false, clinicalSignificance: 'high',
    howTo: 'Bright light into OD. Normal=blink. Subcortical reflex; preserved in cortical blindness.',
    testType: 'boolean',
    positiveLabel: 'Present', positiveLabelKo: '양성',
    negativeLabel: 'Absent', negativeLabelKo: '음성',
  ...
  {
    testID: 'dazzle_os', testName: 'Dazzle Reflex (OS)', testNameKo: '눈부심 반사 (좌안)',
    domain: 'vision_assessment', eye: 'OS', species: 'both', required: false, clinicalSignificance: 'high',
    testType: 'boolean',
    positiveLabel: 'Present', positiveLabelKo: '양성',
    negativeLabel: 'Absent', negativeLabelKo: '음성',
    positiveIsAbnormal: false, negativeSigns: ['dazzle_deficit_os'],
