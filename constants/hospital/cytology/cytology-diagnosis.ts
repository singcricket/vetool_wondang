...
export const cytologyDiagnosisRules: CytologyDiagnosisRule[] = [
  ...
  // ── VAGINAL ──────────────────────────────────────────────
  {
    diagnosisId: 'vag_proestrus',
    nameKo: '발정 전기 (Proestrus)',
    nameEn: 'Proestrus',
    category: 'hormonal',
    applicableSampleTypes: ['vaginal'],
    requiredSigns: ['vag_rbc_present'],
    supportingSigns: ['vag_intermediate_dominant', 'vag_neutrophils_few'],
    exclusionSigns: ['vag_superficial_dominant', 'vag_parabasal_dominant'],
    baseConfidence: 65,
    supportingWeight: 10,
    maxConfidence: 85,
    descriptionKo: '발정 전기 세포상. 적혈구 다수 + 중간형 세포 우세. 핵이 있는 중간형/표층형 세포 혼합.',
    treatmentHintKo: '주기 추적 위해 반복 검사 필요.',
  },
  {
    diagnosisId: 'vag_estrus',
    nameKo: '발정기 (Estrus)',
    nameEn: 'Estrus',
    category: 'hormonal',
    applicableSampleTypes: ['vaginal'],
    requiredSigns: ['vag_superficial_dominant'],
    supportingSigns: ['vag_cornified_cells'],
    exclusionSigns: ['vag_neutrophils_many', 'vag_parabasal_dominant'],
    baseConfidence: 75,
    supportingWeight: 12,
    maxConfidence: 92,
    descriptionKo: '발정기 세포상. 무핵/각화된 표층형 세포(>80%) 우세. 에스트로겐 최고조.',
    treatmentHintKo: '교배 적기 확인. LH surge 후 2-3일.',
  },
  {
    diagnosisId: 'vag_diestrus',
    nameKo: '발정 후기 (Diestrus)',
    nameEn: 'Diestrus / Metestrus',
    category: 'hormonal',
    applicableSampleTypes: ['vaginal'],
    requiredSigns: ['vag_neutrophils_many'],
    supportingSigns: ['vag_parabasal_dominant', 'vag_intermediate_dominant'],
    exclusionSigns: ['vag_superficial_dominant'],
    baseConfidence: 70,
    supportingWeight: 10,
    maxConfidence: 88,
    descriptionKo: '발정 후기 세포상. 호중구 갑작스런 증가, 표층형 세포 감소. Diestrus 시작 징후.',
  },
  {
    diagnosisId: 'vag_anestrus',
    nameKo: '무발정기 (Anestrus)',
    nameEn: 'Anestrus',
    category: 'hormonal',
    applicableSampleTypes: ['vaginal'],
    requiredSigns: ['vag_parabasal_dominant'],
    supportingSigns: [],
    exclusionSigns: ['vag_superficial_dominant', 'vag_rbc_present'],
    baseConfidence: 70,
    supportingWeight: 5,
    maxConfidence: 85,
    descriptionKo: '무발정기 세포상. 기저방층형(parabasal) 세포 우세, 에스트로겐 영향 최소.',
  },
  {
    diagnosisId: 'vag_vaginitis',
    nameKo: '질염 (Vaginitis)',
    nameEn: 'Vaginitis',
    category: 'infection',
    applicableSampleTypes: ['vaginal'],
    requiredSigns: ['vag_bacteria_many'],
    supportingSigns: ['vag_neutrophils_many', 'vag_bacteria_few'],
    baseConfidence: 65,
    supportingWeight: 10,
    maxConfidence: 88,
    descriptionKo: '질강 내 세균 과증식 및 염증. 세균성 질염.',
    treatmentHintKo: '배양·감수성 검사 후 항생제 국소/전신 투여.',
    additionalTestsKo: ['질 분비물 배양·감수성'],
  },

  // ── CONJUNCTIVAL ─────────────────────────────────────────
  {
    diagnosisId: 'conj_bacterial_conjunctivitis',
    nameKo: '세균성 결막염',
    nameEn: 'Bacterial Conjunctivitis',
    category: 'infection',
    malignancyGrade: 'benign',
    applicableSampleTypes: ['conjunctival'],
    requiredSigns: ['conj_cocci_present'],
    supportingSigns: ['conj_rods_present', 'conj_neutrophils_present'],
    baseConfidence: 65,
    supportingWeight: 10,
    maxConfidence: 90,
    descriptionKo: '세균성 결막염. 호중구 침윤 + 구균/간균 확인.',
    treatmentHintKo: '항생제 점안액(ofloxacin, tobramycin). 배양·감수성 고려.',
  },
  {
    diagnosisId: 'conj_chlamydia',
    nameKo: '클라미디아 결막염 (고양이)',
    nameEn: 'Chlamydial Conjunctivitis',
    category: 'infection',
    applicableSampleTypes: ['conjunctival'],
    requiredSigns: ['conj_inclusion_bodies'],
    supportingSigns: ['conj_neutrophils_present'],
    baseConfidence: 80,
    supportingWeight: 8,
    maxConfidence: 92,
    descriptionKo: '클라미디아 세포 내 봉입체(inclusion body) 확인. 고양이 결막염의 주요 원인.',
    treatmentHintKo: 'Doxycycline 전신 투여 (6주). 국소 tetracycline 안연고.',
  },
  {
    diagnosisId: 'conj_allergic_conjunctivitis',
    nameKo: '알레르기성 결막염',
    nameEn: 'Allergic Conjunctivitis',
    category: 'inflammation',
    applicableSampleTypes: ['conjunctival'],
    requiredSigns: ['conj_eosinophils_present'],
    supportingSigns: ['conj_mast_cells_present'],
    exclusionSigns: ['conj_neutrophils_present'],
    baseConfidence: 65,
    supportingWeight: 12,
    maxConfidence: 88,
    descriptionKo: '호산구 + 비만세포 주체 알레르기성 결막염.',
    treatmentHintKo: '항히스타민 점안액, 저용량 스테로이드 점안. 원인 항원 회피.',
  },
  {
    diagnosisId: 'conj_kcs_related',
    nameKo: '건성 각결막염 관련 염증',
    nameEn: 'KCS-related Conjunctivitis',
    category: 'inflammation',
    applicableSampleTypes: ['conjunctival'],
    requiredSigns: ['conj_goblet_cells_increased'],
    supportingSigns: ['conj_neutrophils_present', 'conj_lymphocytes_present'],
    baseConfidence: 60,
    supportingWeight: 8,
    maxConfidence: 82,
    descriptionKo: '배상세포 증가 + 만성 염증. KCS(건성 각결막염) 동반 가능성.',
    treatmentHintKo: 'Schirmer 눈물 검사 권장. Cyclosporine 안약, 인공눈물.',
    additionalTestsKo: ['Schirmer Tear Test'],
  },
...
export const VALUE_TO_SIGN_REGISTRY: Record<string, CytologySign[]> = {
  ...
  // Vaginal
  vag_superficial_dominant: ['vag_superficial_dominant'],
  vag_intermediate_dominant: ['vag_intermediate_dominant'],
  vag_parabasal_dominant: ['vag_parabasal_dominant'],
  vag_cornified_cells: ['vag_cornified_cells'],
  vag_neutrophils_few: ['vag_neutrophils_few'],
  vag_neutrophils_many: ['vag_neutrophils_many', 'vag_neutrophils_few'],
  vag_bacteria_few: ['vag_bacteria_few'],
  vag_bacteria_many: ['vag_bacteria_many', 'vag_bacteria_few'],
  vag_rbc_present: ['vag_rbc_present'],
  // Conjunctival
  conj_cocci_present: ['conj_cocci_present'],
  conj_rods_present: ['conj_rods_present'],
  conj_neutrophils_present: ['conj_neutrophils_present'],
  conj_eosinophils_present: ['conj_eosinophils_present'],
  conj_mast_cells_present: ['conj_mast_cells_present'],
  conj_inclusion_bodies: ['conj_inclusion_bodies'],
  conj_goblet_cells_increased: ['conj_goblet_cells_increased'],
  conj_lymphocytes_present: ['conj_lymphocytes_present'],
  // Specialist — Inflammation
