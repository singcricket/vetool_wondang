...
export interface SelectOption {
  ...
  resultText: string;             // 차트 출력 문구 (영문)
  resultTextKo: string;           // 차트 출력 문구 (한국어)
    ...
    options: [
      {
        ...
        label: 'Renal pelvis',
        labelKo: '신우',
        resultText: 'Nephrolithiasis located in renal pelvis',
        resultTextKo: '신우 내 신결석',
        isAbnormal: true, severity: 'moderate',
      },
      {
        value: 'parenchyma',
        ...
        labelKo: '신실질 (신장 석회화)',
        resultText: 'Renal parenchymal mineralisation (nephrocalcinosis)',
        resultTextKo: '신실질 석회화 (신장 석회화증)',
        isAbnormal: true, severity: 'moderate',
      },
      {
        value: 'bilateral',
        label: 'Bilateral',
        labelKo: '양측성',
        resultText: 'Bilateral nephrolithiasis identified',
        resultTextKo: '양측성 신결석 관찰',
        isAbnormal: true, severity: 'severe',
      },
    ],
  },
    ...
    options: [
      {
        ...
        label: 'Trigone',
        labelKo: '삼각부',
        resultText: 'Bladder mass at trigone; transitional cell carcinoma strongly suspected',
        resultTextKo: '삼각부 방광 종괴; 이행상피세포암 강력 의심',
        isAbnormal: true, severity: 'severe',
      },
      {
        value: 'cranial',
        label: 'Cranial / Apex',
        labelKo: '전방/첨부',
        resultText: 'Bladder mass at cranial aspect/apex',
        resultTextKo: '방광 전방/첨부 종괴',
        isAbnormal: true, severity: 'moderate',
      },
      {
        value: 'lateral_wall',
        label: 'Lateral wall',
        labelKo: '측벽',
        resultText: 'Bladder mass at lateral wall',
        resultTextKo: '방광 측벽 종괴',
        isAbnormal: true, severity: 'moderate',
      },
      {
        value: 'diffuse',
        ...
        labelKo: '미만성/전주',
        resultText: 'Diffuse bladder wall thickening with mural lesion; severe cystitis or carcinoma in situ suspected',
        resultTextKo: '미만성 방광벽 비후를 동반한 벽 내 병변; 중증 방광염 또는 상피내암종 의심',
        isAbnormal: true, severity: 'severe',
      },
    ],
  },
    ...
    options: [
      {
        ...
        labelKo: '우엽 / 십이지장 분지',
        resultText: 'Pancreatic mass in right lobe (duodenal limb)',
        resultTextKo: '우엽(십이지장 분지) 췌장 종괴',
        isAbnormal: true, severity: 'severe',
      },
      {
        value: 'body',
        label: 'Body',
        labelKo: '체부',
        resultText: 'Pancreatic mass in body',
        resultTextKo: '체부 췌장 종괴',
        isAbnormal: true, severity: 'severe',
      },
      {
        value: 'left_lobe',
        ...
        labelKo: '좌엽 / 비장 분지',
        resultText: 'Pancreatic mass in left lobe (splenic limb)',
        resultTextKo: '좌엽(비장 분지) 췌장 종괴',
        isAbnormal: true, severity: 'severe',
      },
    ],
  },
    ...
    options: [
      {
        ...
        label: 'Stomach',
        labelKo: '위',
        resultText: 'Foreign body in stomach',
        resultTextKo: '위 내 이물',
        isAbnormal: true, severity: 'moderate',
      },
      {
        ...
        label: 'Duodenum',
        labelKo: '십이지장',
        resultText: 'Foreign body in duodenum',
        resultTextKo: '십이지장 내 이물',
        isAbnormal: true, severity: 'severe',
      },
      {
        value: 'jejunum_ileum',
        label: 'Jejunum / Ileum',
        labelKo: '공장/회장',
        resultText: 'Foreign body in jejunum/ileum',
        resultTextKo: '공장/회장 내 이물',
        isAbnormal: true, severity: 'severe',
      },
      {
        value: 'colon',
        label: 'Colon',
        labelKo: '결장',
        resultText: 'Foreign body in colon',
        resultTextKo: '결장 내 이물',
        isAbnormal: true, severity: 'moderate',
      },
    ],
  },
    ...
    options: [
      {
        ...
        label: 'Stomach',
        labelKo: '위',
        resultText: 'GI mass in stomach; adenocarcinoma or leiomyoma suspected',
        resultTextKo: '위 내 종괴; 선암종 또는 평활근종 의심',
        isAbnormal: true, severity: 'severe',
      },
      {
        ...
        labelKo: '소장',
        resultText: 'GI mass in small intestine; lymphoma or adenocarcinoma suspected',
        resultTextKo: '소장 내 종괴; 림프종 또는 선암종 의심',
        isAbnormal: true, severity: 'severe',
      },
      {
        ...
        labelKo: '대장',
        resultText: 'GI mass in large intestine; adenocarcinoma or polyp suspected',
        resultTextKo: '대장 내 종괴; 선암종 또는 폴립 의심',
        isAbnormal: true, severity: 'severe',
      },
    ],
  },
    ...
    for (const test of section.tests) {
      ...
      if (resultText) {
        ...
        if (targetOrgan && (section.organ.includes('left_') || section.organ.includes('right_'))) {
          lines.push(`[${section.organNameKo}] ${resultText}`);
        } else {
