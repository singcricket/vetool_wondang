...
export const syndromeRules: SyndromeRule[] = [
  ...
  // ── Central Vestibular Syndrome ───────────────────────────
  {
    ...
    locations: ['vestibular_central','midbrain','pons','medulla', 'cerebellum'],
    urgency: 'emergency',
  },
...
export const localisationRules: LocalisationRule[] = [
  ...
  // ── C1–C5 ─────────────────────────────────────────────────
  {
    ...
    requiredSigns: [],
    supportingSigns: ['UMN_thoracic', 'UMN_pelvic', 'tetraparesis', 'tetraplegia', 'hemiparesis_left', 'hemiparesis_right', 'cervical_pain', 'proprioception_deficit_thoracic_left', 'proprioception_deficit_thoracic_right'],
    minSupportCount: 2,
  ...
  // ── C6–T2 ─────────────────────────────────────────────────
  {
    ...
    supportingSigns: ['UMN_pelvic', 'horners_miosis', 'proprioception_deficit_thoracic_left', 'proprioception_deficit_thoracic_right', 'cervical_pain', 'biceps_absent', 'triceps_absent'],
    minSupportCount: 1,
  ...
  // ── T3–L3 ─────────────────────────────────────────────────
  {
    ...
    requiredSigns: ['UMN_pelvic'],
    supportingSigns: ['thoracolumbar_pain', 'schiff_sherrington', 'proprioception_deficit_pelvic_left', 'proprioception_deficit_pelvic_right', 'babinski_present', 'crossed_extensor_present', 'urinary_retention_UMN', 'paraparesis', 'paraplegia'],
    minSupportCount: 1,
  ...
  // ── L4–S3 ─────────────────────────────────────────────────
  {
    ...
    requiredSigns: ['LMN_pelvic'],
    supportingSigns: ['patellar_absent', 'patellar_decreased', 'withdrawal_absent', 'lumbosacral_pain', 'urinary_incontinence_LMN', 'faecal_incontinence', 'perineal_absent', 'proprioception_deficit_pelvic_left', 'proprioception_deficit_pelvic_right'],
    minSupportCount: 1,
