...
import { cytologySearchedPatientColumns } from './cytology-searched-patient-columns'
...
export default function CytologySearchPatientTab({ hosId, targetDate, setOpen, onRegistered }: Props) {
    ...
    <div className="flex h-[540px] flex-col gap-2">
      ...
      <div className="relative h-full overflow-hidden border">
        {isSearching ? (
          ...
          <DataTable
            columns={cytologySearchedPatientColumns({ hosId, targetDate, setIsRegisterDialogOpen: setOpen, onRegistered })}
