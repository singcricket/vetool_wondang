...
import CytologySelectPatientDialog from './cytology-select-patient-dialog'
...
export const cytologySearchedPatientColumns = ({
  hosId,
  targetDate,
  ...
  {
    accessorKey: 'register_cytology_action',
    header: () => '환자선택',
    cell: ({ row }) => (
      <CytologySelectPatientDialog
