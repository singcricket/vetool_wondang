...
import { oncologySearchedPatientColumns } from './oncology-searched-patient-columns'
...
export default function OncologySearchPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
    ...
    <div className="flex h-[540px] flex-col gap-2">
      ...
      <div className="relative h-full overflow-hidden border rounded-md">
        {isSearching ? (
          ...
          <DataTable
            columns={oncologySearchedPatientColumns({
              hosId,
              targetDate,
