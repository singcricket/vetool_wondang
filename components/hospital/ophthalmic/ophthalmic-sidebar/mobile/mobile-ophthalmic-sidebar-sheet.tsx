...
import { MobileOphthalmicSidebar } from './mobile-ophthalmic-sidebar'
import { OphthalmicSidebarItem } from '@/lib/services/ophthalmic/fetch-ophthalmic'
...
export function MobileOphthalmicSidebarSheet({
  items,
  targetDate,
  hosId,
}: Props) {
    ...
    <div className="2xl:hidden">
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        ...
        <SheetContent side="left" className="w-[240px] px-0 py-2" noCloseButton>
          <VisuallyHidden>
            <SheetHeader>
              <SheetTitle>안과 진료 차트 사이드바</SheetTitle>
              <SheetDescription>
