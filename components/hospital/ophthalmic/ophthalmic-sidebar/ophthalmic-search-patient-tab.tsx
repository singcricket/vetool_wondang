...
import { ophthalmicSearchedPatientColumns } from './ophthalmic-searched-patient-columns'
...
export default function OphthalmicSearchPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
    ...
    <div className="flex h-[540px] flex-col gap-2">
      ...
      <div className="relative h-full overflow-hidden border rounded-md">
        {isSearching ? (
          ...
          <DataTable
            columns={ophthalmicSearchedPatientColumns({
              hosId,
              targetDate,
