...
import UltrasoundSelectPatientDialog from './ultrasound-select-patient-dialog'
...
export const ultrasoundSearchedPatientColumns = ({
  hosId,
  targetDate,
  ...
  {
    accessorKey: 'register_ultrasound_action',
    header: () => '환자선택',
    cell: ({ row }) => (
      <UltrasoundSelectPatientDialog
