...
import { ultrasoundSearchedPatientColumns } from './ultrasound-searched-patient-columns'
...
export default function UltrasoundSearchPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
      ...
      <div className="h-full flex-1">
        {isSearching ? (
          ...
          <DataTable
            ...
            columns={ultrasoundSearchedPatientColumns({
              hosId,
              targetDate,
