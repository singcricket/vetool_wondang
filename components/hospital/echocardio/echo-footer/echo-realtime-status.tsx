...
const STORAGE_KEY = 'echo-realtime-reload'
...
export default function EchoRealtimeStatus() {
  const isRealtimeReady = useZustandEchoRealtimeStore(
  ...
  useEffect(() => {
    ...
    document.addEventListener('visibilitychange', checkRealtimeStatus)
    ...
    return () => {
      ...
      document.removeEventListener('visibilitychange', checkRealtimeStatus)
    }
  }, [isRealtimeReady])
