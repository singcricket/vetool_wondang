...
import EchoSelectPatientDialog from './echo-select-patient-dialog'
...
export const echoSearchedPatientColumns = ({
  hosId,
  targetDate,
  ...
  {
    accessorKey: 'register_echo_action',
    header: () => '환자선택',
    cell: ({ row }) => (
      <EchoSelectPatientDialog
