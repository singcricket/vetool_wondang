...
import { registerPatientAndDentalChart } from '@/lib/services/dental/register-dental'
...
export default function DentalNewPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
  ...
  const handleRegister = async (
    ...
    const dentalChartId = await registerPatientAndDentalChart({
      hosId,
