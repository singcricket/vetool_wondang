...
import { dentalSearchedPatientColumns } from './dental-searched-patient-columns'
...
export default function DentalSearchPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
      ...
      <div className="h-full flex-1">
        {isSearching ? (
          ...
          <DataTable
            ...
            columns={dentalSearchedPatientColumns({
              hosId,
              targetDate,
