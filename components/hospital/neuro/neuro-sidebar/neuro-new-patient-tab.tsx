...
import { registerPatientAndNeuroChart } from '@/lib/services/neuro/register-neuro'
...
export default function NeuroNewPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
  ...
  const handleRegister = async (
    ...
    try {
      ...
      const chartId = await registerPatientAndNeuroChart({
        hosId,
