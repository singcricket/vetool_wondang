...
import { neuroSearchedPatientColumns } from './neuro-searched-patient-columns'
...
export default function NeuroSearchPatientTab({
  hosId,
  targetDate,
  setOpen,
  onRegistered,
    ...
    <div className="flex h-[540px] flex-col gap-2">
      ...
      <div className="relative h-full overflow-hidden border">
        {isSearching ? (
          ...
          <DataTable
            columns={neuroSearchedPatientColumns({
              hosId,
              targetDate,
