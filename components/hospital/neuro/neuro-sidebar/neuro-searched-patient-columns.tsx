...
import NeuroSelectPatientDialog from './neuro-select-patient-dialog'
...
export const neuroSearchedPatientColumns = ({
  hosId,
  targetDate,
  ...
  {
    accessorKey: 'register_neuro_action',
    header: () => '환자선택',
    cell: ({ row }) => (
      <NeuroSelectPatientDialog
