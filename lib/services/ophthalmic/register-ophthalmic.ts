...
interface RegisterOphthalmicChartProps {
  hosId: string
  patientId: string
  targetDate: string
...
export async function registerOphthalmicChart({
  hosId,
  patientId,
  targetDate,
  evaluatorId = null,
  vetId = null,
}: RegisterOphthalmicChartProps) {
...
export async function registerPatientAndOphthalmicChart(params: {
  hosId: string
  chartDate: string
  patient: {
    name: string
